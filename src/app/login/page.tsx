      ...
      <div className="max-w-5xl w-full min-h-[600px] bg-white rounded-[2rem] shadow-[0_0_60px_-15px_rgba(79,70,229,0.4)] flex flex-col-reverse lg:flex-row overflow-hidden relative z-10">
        ...
        <div className="w-full lg:w-[45%] bg-white p-10 sm:p-14 flex flex-col justify-center relative z-20">
          <div className="max-w-sm mx-auto w-full">
            ...
            <div className="mt-8">
              <p className="text-center text-xs font-medium text-zinc-500 mb-4">
                {isLogin ? "Ou entre usando" : "Ou registre-se usando"}
              </p>
              <div className="flex justify-center gap-3">
                <button 
                  onClick={handleGoogleLogin} 
                  disabled={isLoading}
                  className="w-10 h-10 rounded-full bg-white border border-zinc-200 shadow-sm flex items-center justify-center hover:bg-zinc-50 hover:scale-105 transition-all cursor-pointer"
                >
